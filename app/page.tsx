			...
			<div className='relative z-10 text-center space-y-12 max-w-4xl mx-auto text-white'>
				...
				<div className='space-y-8'>
					<p className='text-xl sm:text-2xl text-gray-300 max-w-2xl mx-auto leading-relaxed'>
						Join the ranks of elite gamers, represent your university, and
						compete for glory in KUER s groundbreaking esports tournaments!
					</p>

					{/* Improved CTA button */}
					<div>
            <Button
              className="bg-gray-500 text-white font-bold py-4 px-8 rounded-full text-xl sm:text-2xl cursor-not-allowed"
              disabled
            >
              Registration Closed
            </Button>
				...
				>
					<Image
						src='/controller_icon_160216.svg'
						alt='Game Controller'
						width={60}
						height={60}
					/>
					<Image
						src='/trophy_icon-icons.com_64403.svg'
						alt='Trophy'
						width={60}
						height={60}
					/>
					<Image
						src='/headset-mic_119056.svg'
						alt='Gaming Headset'
						width={60}
						height={60}
					/>
				...
				<div className='mt-16 p-8 bg-white bg-opacity-10 rounded-lg backdrop-filter backdrop-blur-lg'>
					<h2 className='text-3xl font-bold text-yellow-300 mb-4 font-orbitron'>
						An Amazing Website is Coming Soon!
					</h2>
					<p className='text-xl text-gray-200 leading-relaxed'>
						This is just a glimpse of what s to come. We re working on an
						incredible platform that will revolutionize university esports in
						Kenya. Stay tuned for mind-blowing features, seamless tournament
						experiences, and a community like no other!
					</p>
				</div>
				{/* <CountdownTimer endDate={new Date("2024-02-12T23:59:59")} /> */}
        <div className="mt-8 p-6 bg-red-500 text-white rounded-lg shadow-lg">
          ...
          <p className="text-lg">
			...
			<div className='absolute bottom-4 left-0 right-0 flex justify-between items-center px-4 text-sm text-gray-400'>
				<p>
					© {new Date().getFullYear()} KUER - Igniting the Esports Revolution
				</p>
				<SocialLinks />
			</div>
		</div>
