	...
	const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
		...
		try {
			const uploadFiles = async (file: File | Blob) => {
				...
				try {
					let uploadResult;
					// Create a new File object with a valid name if file is not an instance of File with a name
					const fileToUpload =
						file instanceof File && file.name
							? file
							: new File([file], `${fileType}_${Date.now()}.${fileType}`, {
									type: file.type,
							  });
			...
			submitFormData.append("passportPhotoUrl", passportPhotoResult.url);
			submitFormData.append(
				"discordScreenshotUrl",
				discordScreenshotResult.url
			);
										...
										<section>
											...
											<ol className='list-decimal pl-5 space-y-1'>
												...
												<li>
													...
													the player  s end, including connectivity problems
										...
										<section>
											...
											<ol className='list-decimal pl-5 space-y-1'>
												...
												<li>
													Any changes will be{" "}
													<strong>
														communicated via KUER  s official website and
