	...
	const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
		...
		try {
				...
				try {
					...
					if (file instanceof Blob) {
						if (file instanceof File) {
							...
							uploadResult = await uploadToBlob(file, fileName);
						} else {
							const blobFile = blobToFile(file, "blob-upload");
							uploadResult = await uploadToBlob(blobFile, blobFile.name);
						}
					} else {
			...
			if (formData.boardsiderScreenshot) {
				boardsiderScreenshotResult = await uploadFile(
			...
			submitFormData.append("passportPhotoUrl", passportPhotoResult);
			submitFormData.append("discordScreenshotUrl", discordScreenshotResult);
			submitFormData.append("studentProofUrl", studentProofResult);
			submitFormData.append("nationalIdUrl", nationalIdResult);
		...
		<form onSubmit={handleSubmit} className='space-y-6'>
					...
					<div className='bg-muted/50 p-4 rounded-lg space-y-2'>
						...
						{(isCODM || isPUBGM) && (
							<>
								...
								<p>
									Boardsider Username:{" "}
									{formData.boardsiderUsername || "Not provided"}
								</p>
								...
								{formData.hasTeam === "yes" && (
									<>
										...
										<p>
											Player Role:{" "}
											{formData.playerRole === "main"
												? "Main Player"
												: "Substitute"}
										</p>
										<p>
											Team Captain:{" "}
											{formData.isCaptain === "yes" ? "Yes" : "No"}
										</p>
										{formData.isCaptain === "no" && (
											<p>
												Team Captain s Name:{" "}
												{formData.teamCaptainName || "Not provided"}
											</p>
										)}
									</>
								)}
						...
						{isEAFC2v2Open && (
							<>
								<p>
									Has 2v2 Partner:{" "}
									{formData.has2v2Partner === "yes" ? "Yes" : "No"}
								</p>
			...
			<div className='space-y-4'>
				<div className='flex items-center space-x-2'>
					<Checkbox
						...
						onCheckedChange={(checked) =>
							updateFormData({ confirmAccuracy: checked === true })
						}
					/>
				...
				<div className='flex items-center space-x-2'>
					<Checkbox
						...
						onCheckedChange={(checked) =>
							updateFormData({ agreeToRules: checked === true })
						}
					/>
				...
				<div className='text-sm text-muted-foreground'>
					...
					<Dialog>
						...
						<DialogContent className='max-w-3xl max-h-[80vh] overflow-y-auto'>
							<DialogHeader>
								<DialogTitle>
									Kenya University Esports Rankings (KUER) Terms and Conditions
								</DialogTitle>
								<DialogDescription>
									<div className='space-y-6 mt-4'>
										<section>
											...
											<ol className='list-decimal pl-5 space-y-1'>
												<li>
													Participants{" "}
													<strong>
														must be registered university students in Kenya
													</strong>
													.
												</li>
												<li>
													Players{" "}
													<strong>must provide valid identification</strong>,
													including:
												...
												<li>
													Players must provide requested details to help KUER
													run tournaments{" "}
										...
										<section>
											...
											<ol className='list-decimal pl-5 space-y-1'>
												<li>
													Players{" "}
													<strong>
														must adhere to KUER s competition rules
													</strong>{" "}
													and guidelines for <strong>fair play</strong>.
												</li>
												<li>
													<strong>
														Cheating, hacking, or exploiting in-game bugs
													</strong>{" "}
													will result in <strong>disqualification</strong>.
												</li>
												<li>
													<strong>Unsportsmanlike behavior</strong> (harassment,
												...
												<li>
													Participants{" "}
													<strong>
														must respect tournament administrators, referees,
														and fellow competitors
													</strong>
													.
												</li>
												<li>
													Players <strong>must be punctual</strong> and plan
													ahead, especially for <strong>LAN events</strong>. If
													a player{" "}
													<strong>
														cannot attend a required physical event, they should
														not register
													</strong>
													.
												</li>
										...
										<section>
											...
											<ol className='list-decimal pl-5 space-y-1'>
												<li>
													If cash prizes apply,{" "}
													<strong>KUER has up to 30 days</strong> after the
													tournament to process and distribute payments.
												</li>
												<li>
													Payments will be made{" "}
													<strong>via the agreed-upon method</strong>{" "}
													communicated before the tournament.
												</li>
												<li>
													<strong>
														Players must provide correct payment details
													</strong>
													. KUER is <strong>not responsible</strong> for issues
													due to incorrect information.
												</li>
												<li>
													<strong>Violation of KUER rules</strong> may result in{" "}
													<strong>forfeiture of prizes</strong>.
												</li>
											</ol>
										</section>
										...
										<section>
											<h2 className='text-xl font-bold'>
												4. Use of Player Content
											</h2>
											<ol className='list-decimal pl-5 space-y-1'>
												<li>
													By participating, players{" "}
													<strong>grant KUER permission</strong> to use their:
													<ul className='list-disc pl-5'>
														<li>
														...
														<li>
															...
															<strong>
																marketing, promotions, and content creation
															</strong>
															.
														</li>
													</ul>
												...
												<li>
													KUER <strong>may publish this content</strong> on its
													website, social media, and other media platforms{" "}
													<strong>
										...
										<section>
											<h2 className='text-xl font-bold'>
												5. Streaming and Media Rights
											</h2>
											<ol className='list-decimal pl-5 space-y-1'>
												<li>
													<strong>
														KUER reserves the right to stream, record, and
														distribute
													</strong>{" "}
													gameplay and competition footage.
												</li>
												<li>
													<strong>
														Players who wish to stream their matches must obtain
														prior approval
													</strong>{" "}
													from KUER and follow branding guidelines.
												</li>
												<li>
													<strong>
														Unauthorized third-party broadcasting or
														monetization
													</strong>{" "}
													of KUER events <strong>is prohibited</strong>.
												</li>
											</ol>
										</section>
										...
										<section>
											<h2 className='text-xl font-bold'>
												6. Team and Player Responsibilities
											</h2>
											<ol className='list-decimal pl-5 space-y-1'>
												<li>
													Teams <strong>must register their rosters</strong>{" "}
													before the tournament deadline.
												</li>
												<li>
													<strong>Roster changes</strong> must be communicated{" "}
													<strong>in advance</strong> to KUER officials.
												</li>
												<li>
													Players <strong>are responsible</strong> for having a{" "}
													<strong>
														stable internet connection and necessary gaming
														equipment
													</strong>
													.
												</li>
												<li>
													KUER{" "}
													<strong>is not liable for technical issues</strong> on
													the player s end, including connectivity problems or
													hardware failures.
												</li>
											</ol>
										</section>
										...
										<section>
											...
											<ol className='list-decimal pl-5 space-y-1'>
												<li>
													KUER <strong>reserves the right</strong> to take
													...
													<ul className='list-disc pl-5'>
														...
														<li>
															<strong>Permanent bans</strong> for rule
															violations.
														</li>
													</ul>
												</li>
												<li>
													Appeals <strong>must be submitted in writing</strong>{" "}
													to KUER <strong>within 48 hours</strong> of
													disciplinary action.
												</li>
											</ol>
										</section>
										...
										<section>
											...
											<ol className='list-decimal pl-5 space-y-1'>
												<li>
													KUER <strong>reserves the right to update</strong>{" "}
													these terms and conditions at any time.
												</li>
												<li>
													Any changes will be{" "}
													<strong>
														communicated via KUER s official website and social
														media channels
													</strong>
													.
												</li>
										...
										<section>
											...
											<p>
												By participating in KUER,{" "}
												<strong>all players acknowledge and agree</strong> to
			...
			<div className='flex justify-between'>
				...
				<Button
					type='submit'
					disabled={
						isSubmitting || !formData.confirmAccuracy || !formData.agreeToRules
					}
				>
