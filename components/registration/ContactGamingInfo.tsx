...
import { GamepadIcon as GameController, ExternalLink, CheckCircle, XCircle } from "lucide-react"
...
const formSchema = z.object({
  ...
  discordScreenshot: z
    .any()
    .refine(
      (file) => file instanceof File || file instanceof Blob || typeof file === "string",
      ...
      boardsiderScreenshot:
        values.boardsiderScreenshot instanceof File
          ...
          : formData.boardsiderScreenshot instanceof File
            ...
            : undefined,
      // Ensure has2v2Partner is properly set
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        >
          <svg className="w-6 h-6 mr-2" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
              fill="currentColor"
        ...
        <div className="bg-blue-900 p-4 rounded-lg mb-4">
          ...
          <p className="text-sm">
            Please join our Discord server and take a screenshot showing your username before uploading. This will be
            used to assign your tournament role.
          </p>
        </div>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Upload a screenshot showing your Discord username in our server (JPG/PNG, max 5MB)
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="Enter your Boardsider username" />
                  </FormControl>
                  <FormDescription>
                    ...
                    >
                      Boardsider <ExternalLink className="inline-block w-4 h-4" />
                    </a>{" "}
                    and enter your username here. This helps in scoring and finding MVPs.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Upload a screenshot of your Boardsider profile showing your username (JPG/PNG, max 5MB)
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
